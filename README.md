...
<figure>
	<img src="Figures/Imputation_Volcano.tiff" alt="Distribution of Protein Expression, comparing Imputation validity on the Percentage of Peptides Missing within a PSM Matrix. Here, Four treatment replicates of Morphine treated cells vs four Control replicates of non-Morphine treated cells show a trend between two Imputed PSM Matrices and a non-Imputated Matrix.">
	<figcaption><strong>Figure 1. Distribution of Protein Expression, comparing Imputation validity on the Percentage of Peptides Missing within a PSM Matrix. Here, Four treatment replicates of Morphine treated cells vs four Control replicates of non-Morphine treated cells show a trend between two Imputed PSM Matrices and a non-Imputated Matrix.</strong></figcaption>
</figure>
<br><br>
