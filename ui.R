...
shinyUI(fluidPage(theme=shinytheme("darkly"),
                  tabsetPanel(type="tabs",
                              ...
                              tabPanel("DET Corrector.",
                                ...
                                textInput('detecctionError', 'Detection Coefficients.'),
                                textInput('experimentalError', 'Experimental Coefficients.'),
                                textInput('technicalError', 'Technical Coefficients.'),
                              ...
                              tabPanel("Protein Vector Normalization.",
                                ...
                                actionButton('proteinVectorNormalization', 'Normalize')),
                              tabPanel("Analyze.",
                                ...
                                actionButton('analytics', 'Analyze Statistical and Plots')),
                              tabPanel("Volcano.",
